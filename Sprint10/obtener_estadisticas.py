...
def get_video_metrics(video_urls):
    ...
    with sync_playwright() as p:
        ...
        for url in video_urls:
            ...
            try:
                page.goto(url)
                page.wait_for_selector('strong[data-e2e="like-count"]', timeout=30000)  # Wait for the page to load
                ...
                hashtags_elements = page.query_selector_all('a[href*="/tag/"]')
                hashtags = [tag.inner_text() for tag in hashtags_elements] if hashtags_elements else []
                video_data["Hashtags"] = ', '.join(hashtags) if hashtags else 'N/A'
                ...
                print(f"Hashtags: {video_data['Hashtags']}")
...
archivo_entrada = 'D:\\DDAA\\Sprint10\\ObtenirDades\\urls_martstips.xlsx'
...
archivo_salida = 'D:\\DDAA\\Sprint10\\ObtenirDades\\metriques_martstips.xlsx'
